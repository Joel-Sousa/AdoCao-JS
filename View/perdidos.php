...
<form action="" method="post"> 
		<table style="position: relative; left: 500px;";>
			<tr>
				...
				<td><input type="submit"  class="btn btn-secondary" value=Pesquisar></td>
			</tr>
		</table>
	</form>
	<br>
...
foreach ($cachorro as $c) {
    ...
    if($c["idade"] == 0){
        echo "<tr>	<td><b>Idade:</b> Nao Informado</td>	
		</tr>";
    }else {
    ...
    if(!empty($_SESSION["usuario"])){
        echo "<tr><td><a href='visualizarCao.php?codC={$c["idCachorro"]}&codU={$_SESSION["idUsuario"]}'><input type='button' class='btn btn-success' value='Visualizar' style='width:168;height:28'></a></td></tr>";
    }else {}
    echo "</table>";
}
echo "</td></tr>";
